...
interface ClientApplicationClientFilesContainerProps {
  applicationID: number
}

export default async function ClientApplicationClientFilesContainer({
  applicationID,
}: ClientApplicationClientFilesContainerProps) {
