...
interface AdminApplicationClientFilesContainerProps {
  applicationID: number
}

export default async function AdminApplicationClientFilesContainer({
  applicationID,
}: AdminApplicationClientFilesContainerProps) {
